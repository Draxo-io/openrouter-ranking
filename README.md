...
[![Last Updated](https://img.shields.io/badge/updated-2026-06-12%2009:55%20UTC-blue)](https://github.com/Draxo-io/openrouter-ranking)

> **Updated:** 2026-06-12 09:55 UTC  
...
| ⭐ 2 | `qwen/qwen3-coder` | 🟠 $0.6150 | $0.22 | $1.80 | 8.2x | 1,048,576 | Dedicated 480B coder. 1M context. |
...
| # | Model | $/1M Tokens | Prompt (¢/1M) | Compl (¢/1M) | P/C | Context | Notes |
|---|--------|------------|--------------|--------------|-----|----------|------|
| ⭐ 1 | `qwen/qwen3-vl-235b-a22b-instruct` | 🟡 $0.3700 | $0.20 | $0.88 | 4.4x | 262,144 | 🔥 235B MoE vision. Unbeatable price. |
...
|  5 | `mistralai/mistral-small-3.2-24b-instruct` | 🟢 $0.1062 | $0.07 | $0.20 | 2.7x | 128,000 | 24B multimodal, affordable. |
