...
[![Last Updated](https://img.shields.io/badge/updated-2026-09-21%2017:36%20UTC-blue)](https://github.com/Draxo-io/openrouter-ranking)

> **Updated:** 2026-09-21 17:36 UTC  
> **Total models on OpenRouter:** 440  
> **Paid models analyzed:** 411  
...
| Position | Model | Why |
|----------|------|-----|
| 🥇 Best Overall | `deepseek/deepseek-v4-pro` ($1.16/1M) | Best quality/price ratio across all categories. |
...
|---|--------|------------|--------------|--------------|-----|----------|------|
| ⭐ 1 | `deepseek/deepseek-v4-pro` | 🟠 $1.1597 | $0.93 | $1.86 | 2.0x | 1,048,576 | 🔥 Best overall value. GPT-4o-class quality at flash prices. |
...
| # | Model | $/1M Tokens | Prompt (¢/1M) | Compl (¢/1M) | P/C | Context | Notes |
|---|--------|------------|--------------|--------------|-----|----------|------|
| ⭐ 1 | `deepseek/deepseek-v4-pro` | 🟠 $1.1597 | $0.93 | $1.86 | 2.0x | 1,048,576 | 🔥 Unbeatable: production-quality code at flash prices. |
...
| # | Model | $/1M Tokens | Prompt (¢/1M) | Compl (¢/1M) | P/C | Context | Notes |
|---|--------|------------|--------------|--------------|-----|----------|------|
| ⭐ 1 | `deepseek/deepseek-v4-pro` | 🟠 $1.1597 | $0.93 | $1.86 | 2.0x | 1,048,576 | 🔥 Strong reasoning at lightweight model prices. |
...
|  4 | `deepseek/deepseek-v4-pro` | 🟠 $1.1597 | $0.93 | $1.86 | 2.0x | 1,048,576 | Solid for medium docs (164K ctx). |
